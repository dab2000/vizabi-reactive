...
const MoreOptions = Dialog.extend("moreoptions", {
  ...
  init(config, parent) {
    ...
    this.components = [{
      ...
      model: [config.modelConfig.marker, "ui", "locale"]
    }];
  ...
  readyOnce() {
    ...
    let dialog_moreoptions = (this.model.ui.config.dialogs || {}).moreoptions || [];
    ...
    if (dialog_moreoptions === true) {
      ...
      (this.model.ui.config.dialogs || {}).moreoptions = dialog_moreoptions;
    }
